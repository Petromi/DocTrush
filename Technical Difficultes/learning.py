...
def learning(paths, classnames, modelname):
	...
	if not(os.path.exists('C:\\Users\\'+ getpass.getuser() + '\\Documents\\sorter')):
		os.mkdir('C:\\Users\\'+ getpass.getuser() + '\\Documents\\sorter')

	print('creating a file')
	with open('C:\\Users\\'+ getpass.getuser() + '\\Documents\\sorter\\' + modelname + '.txt', 'w+') as f:
		for i in (classnames):
			f.write(i + '\n')
		f.write('\n')
		f.write('\n')
	...
	path_model = 'C:\\Users\\'+ getpass.getuser() + '\\Documents\\sorter\\' + modelname + '.h5'
